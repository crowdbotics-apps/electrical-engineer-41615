...
## Project Structure
    ...
    ├── electrical_engineer_41615  # Django project configurations
...
1. Clone this repo and `cd electrical_engineer_41615`
...
2. Clone this repo and `cd electrical_engineer_41615`
